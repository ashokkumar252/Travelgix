...
public class AirpositiveGift
{
	...
	public void AirpositiveGift(String Username, String Password, String Leftsidemenu, String ActiveFrom1,
			...
			String AtfdDiscPercent1,String Modeindex,String TravelStatusDN,String  Commonindex,
			String fvoctypelistbox,String fvocnumb) throws Exception

	{
		...
		wm.clickbyxpath("//span[@aria-owns='fvoctype_listbox']");
		Thread.sleep(90);
		wm.sendtextbyxvalue("//input[@aria-owns='fvoctype_listbox']", fvoctypelistbox);
		Thread.sleep(300);
		wm.Listandenter("//*[@id='fvoctype_listbox']/li", Commonindex);
		Thread.sleep(300);
		
		wm.sendtextbycssselecotrwithoutclear("#fvocnumb", ""+fvocnumb);
...
//			Thread.sleep(300);
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("AirpositiveGift", "AirpositiveGift");
