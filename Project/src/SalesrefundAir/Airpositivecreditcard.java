...
public class Airpositivecreditcard
{
	...
	public void Airpositivecreditcard(String Username, String Password, String Leftsidemenu, String ActiveFrom1,
			...
			String Class,String issuemode,String Cardtypedetails,String Commonindex,String fcardnum,
			String fcardDate1,String fcardDate3
) throws Exception
...
wm.Netcollectionsuisngorcandcancellatiocharges("//input[@name='AtfdBaseFare']", "//input[@name='AtfdIncentivePaid']"
		...
		" //input[@name='AtfdAirlineCancelCharge']","Net collection  done correectly using cancelaltion charges", 
