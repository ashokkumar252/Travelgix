...
public class HotelCreditCash
{
	...
	public void HotelCreditCash(String Username, String Password, String Leftsidemenu, String ActiveFrom1,
			...
			String IntlSalesIndicatorAP,String Customerdetails,String Fopdivide) throws Exception
		...
		wm.findbyelementbyxpathandclick("//button[@id='btnhotelsave']");
		 ...
		 wm.sleep();
			...
			wm.Verifythedropdownvalues("//input[@name='DktNumber']",
					"Pass : Sales Refund Hotelpositivecash   created successfuly" + "",
					"Fail:  Sales Refund Hotelpositivecash   not created successfuly " + "");
...
*/
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("HotelCreditCash", "HotelCreditCash");
