...
public class CashUCCF
{
	...
	public void CashUCCF(String Username, String Password, String Leftsidemenu, String ActiveFrom1,
			...
			String AtfdDiscPercent1,String Modeindex,String fApprovenum,String fcardDate1,String fcardDate3,
			String Cardtypedetails,String Commonindex,String fcardnum,String TravelStatusDN,String Selectedbranch,
			String Fopdivide) throws Exception

	{
		...
		Thread.sleep(500);
		wm.Listandenterquick("//*[@id='AAtscPaybackParnerDesc_listbox']/li", Agentincetiveindexx);
		Thread.sleep(500);
...
//Selected the Cash options
		
		
		wm.Listandenterquick("//span[@class='k-icon k-i-add']", "3");
		Thread.sleep(900);
		...
		//wm.sendtextbyxvalue("//input[@aria-owns='AAtscPaybackParnerDesc_listbox']", Agentincetive);
		wm.sendtextbyxvalue("//input[@aria-owns='fbbranch_listbox']", Salesbranch);
		Thread.sleep(300);
		wm.keyboardarrowdownonetime("//input[@aria-owns='fbbranch_listbox']");
		Thread.sleep(200);
		wm.Enterbyxpath("//input[@aria-owns='fbbranch_listbox']");
...
//			Thread.sleep(300);
		...
		wm.Printmessages("AatdTicketNumber is"+AatdTicketNumber);
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("CashUCCF", "CashUCCF");
