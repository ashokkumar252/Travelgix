...
public class Airdockect {
	...
	public void Airdockect(String Username, String Password, String Leftsidemenu,String Docketnumber,String ActiveFrom1,
			...
			String issuemode) throws Exception
...
/*
		wm.Netcollectionsuisngorc("//input[@name='AtfdBaseFare']", "//input[@name='AtfdIncentivePaid']",
				...
				"Net collection  done correectly", "Net collection not done correectly");
		Thread.sleep(200);

		wm.Publishedfareusingorc("//input[@name='AtfdBaseFare']", "//input[@name='AtfdIncentivePaid']",
				"//input[@name='TotalTaxAmount']", "//input[@name='salestotcommm']", "//input[@name='TotInputVat']",
				"//input[@name='Amt_NetPayable']", "Net payable Calclated successfuly",
...
*/
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("Airdockect", "Airdockect");
