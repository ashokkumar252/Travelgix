...
public class Hoteldockect 
{
	...
	public void Hoteldockect(String Username, String Password, String Leftsidemenu,String Docketnumber, String ActiveFrom1,
...
//		Thread.sleep(50);
		...
		wm.sleep();
		 ...
		 wm.sleep();
			...
			wm.Verifythedropdownvalues("//input[@name='DktNumber']",
					"Pass : Sales Refund Hotel using docket   created successfuly" + "",
					"Fail:  Sales Refund Hotel usig docket   not created successfuly " + "");
		...
		wm.Listnegativescearios(utility.Constant.Travelogixuitooltipvalidation, "0",
				"Pass : Sales Refund hotel  created successfuly and Docketnumber is" +Docketnumber,
				"Fail:  Sales Refund hotel  not created successfuly " + "");
		*/
 ...
 wm.close();
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("Hoteldockect", "Hoteldockect");
