...
wm.sendtextbyxvalue(" //input[@onchange='CopyonairTicketChange(this)']", AatdTicketNumber);
Thread.sleep(300);
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@name='AatdTicketStatus']"
	    		, "SALES", "Tickect status  details retrived successfuly", 
	    		"Tickect status  not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='AatdAirlineName_listbox']"
	    		, Airline, "Airline details retrived successfuly", "Airline details not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='AatdBranchKey_listbox']"
	    		, Salesbranch, "Salesbranch details retrived successfuly", 
	    		"Salesbranch details not retrived successfuly");
...
Thread.sleep(200);
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//*[@id='divairheader']/div[10]/div/span[1]/span/span[1]"
		, Class, "Class type details retrived successfuly", 
		"Class type not retrived successfuly");
...
*/
		wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='AatdPayAgntCmsKey_listbox']']"
	    		, Payableagent, "Payableagent details retrived successfuly", 
	    		"Payableagent details not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='AatdSrcAgntCmsKey_listbox']"
	    		, Sourceagent, "Sourceagent details retrived successfuly", 
	    		"Sourceagent details not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='AatdIssueType_listbox']"
	    		, issuemode, "issuemode details retrived successfuly", 
	    		"issuemode details not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='AatdTransTypeDesc_listbox']"
	    		,Servicetype, "Servicetype details retrived successfuly", 
	    		"Servicetype details not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@name='AatdPassengerName']"
	    		,AatdPassengerName, "AatdPassengerName details retrived successfuly", 
	    		"AatdPassengerName details not retrived successfuly");
...
*/
		...
		wm.Verifythealertpopupmessagesnotequal("//input[@aria-owns='AirBookingExecutieveName_listbox']"
	    		,Bookingexecutive, "Bookingexecutive details retrived successfuly", 
	    		"Bookingexecutive details not retrived successfuly");
...
*/
		...
		wm.Verifythealertpopupmessagesnotequal("//input[@aria-owns='AirIssuingExecutieveName_listbox']"
	    		,AirIssuingExecutieveName, "AirIssuingExecutieveName details retrived successfuly", 
	    		"AirIssuingExecutieveName details not retrived successfuly");
...
*/
		...
		wm.Verifythealertpopupmessagesnotequal("//input[@aria-owns='AatdSalesExecutiveName_listbox']"
	    		,Salesexecutive, "Salesexecutive details retrived successfuly", 
	    		"Salesexecutive details not retrived successfuly");
...
*/		
		wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='AatdInterDomestic_listbox']"
	    		,intedomectiv, "intedomectiv details retrived successfuly", 
	    		"intedomectiv details not retrived successfuly");
...
*/
		...
		wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='DestinationDesc_listbox']"
	    		,Destination, "Destination details retrived successfuly", 
	    		"Destination details not retrived successfuly");
/*
