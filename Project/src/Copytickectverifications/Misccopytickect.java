...
public class Misccopytickect
{
	...
	public void Misccopytickect(String Username, String Password, String Leftsidemenu, String ActiveFrom1,
			...
			String FareCalculationAreaAP,String IntlSalesIndicatorAP,String Miscvouchernumber) throws Exception
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='MiscServiceType_listbox']"
	    		, Servicetype, "Servicetype  details retrived successfuly", 
	    		"Servicetype not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='MiscPayableAgentKey_listbox']"
	    		, Payableagent, "Payableagent  details retrived successfuly", 
	    		"Payableagent not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='MiscBookingExecutieveName_listbox']"
	    		, Bookingexecutive, "Bookingexecutive  details retrived successfuly", 
	    		"Bookingexecutive not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='MiscSalesExecutiveName_listbox']"
	    		, Salesexecutive, "Salesexecutive  details retrived successfuly", 
	    		"Salesexecutive not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='MiscCityName_listbox']"
	    		, Cityname, "Cityname  details retrived successfuly", 
	    		"Cityname not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@name='MiscConfirmationNumber']"
	    		, MiscConfirmationNumber, "MiscConfirmationNumber  details retrived successfuly", 
	    		"MiscConfirmationNumber not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='MisctfdProcessTypeKey_listbox']"
	    		, Processtype, "Processtype  details retrived successfuly", 
	    		"Processtype not retrived successfuly");
...
wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//input[@aria-owns='MiscRateCurrencyKey_listbox']"
	    		, Currency, "Currency  details retrived successfuly", 
	    		"Currency not retrived successfuly");
...
*/		wm.sleep();
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("Misccredit", "Misccredit");
