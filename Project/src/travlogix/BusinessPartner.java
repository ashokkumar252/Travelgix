...
public class BusinessPartner {
	...
	public void BusinessPartner(String Username, String Password, String Leftsidemenu, String Account, String SupplierCode,
			...
			String Threshold, String CreditLimitDays, String AecacCreditLimit, String ActiveFrom1, String ActiveFrom2,
			...
			String ANAARGEMSGROUP,String ANAARGEMSFLAG,String DBAGroupcode,String DBAGroupcodeindex,String Locationgroupcode,
			String Locationgroupcodeindex)			throws Exception

	{
		...
		Thread.sleep(500);
		wm.sendtextbycssselecotr("#HeadCode", "" + SupplierCode);
		Thread.sleep(600);
		wm.stabbyxpath("//input[@id='HeadCode']");
		Thread.sleep(600);
		wm.sendtextbycssselecotr("#HeadName", "" + SupplierName);
		Thread.sleep(600);

		wm.sendtextbyxvalue("//input[@aria-owns='objCmsMasterModel_classificationName_listbox']", Suppliertype);
		Thread.sleep(600);
		wm.Listandenter("//*[@id='objCmsMasterModel_classificationName_listbox']/li", Suppliertypeindex);
		Thread.sleep(600);
		...
		wm.sendtextbycssselecotrwithoutclear("#AecacCreditLimit", "" + AecacCreditLimit);
		Thread.sleep(100);
	   ...
	   //===============analysiis detailss==============================================================
		...
		Thread.sleep(600);
		wm.Listandenter("//span[@class='k-icon k-i-add']", "12");
		wm.scrolldownbyxpath("//a[@id='acc1210']");
		Thread.sleep(100);
	
		//province
		
		wm.sendtextbyxvalue("//input[@aria-owns='AR_ANA_PROVINCE_listbox']",Province);
		Thread.sleep(600);
		wm.Listandenter("//*[@id='AR_ANA_PROVINCE_listbox']/li",Provinceindex);
		Thread.sleep(600);
		


		
		wm.sendtextbycssselecotrwithoutclear("#ANA_AR_GEMSGROUP", "" +ANAARGEMSGROUP);		
		wm.sendtextbycssselecotr("#ANA_AR_GEMSFLAG", "" +ANAARGEMSFLAG);	
	
	//DBAGRoupcodee
		
		wm.sendtextbyxvalue("//input[@aria-owns='DBA_GROUP_CODE_listbox']",DBAGroupcode);
		Thread.sleep(600);
		wm.Listandenter("//*[@id='DBA_GROUP_CODE_listbox']/li",DBAGroupcodeindex);
		Thread.sleep(600);
	
	//province
		
		wm.sendtextbyxvalue("//input[@aria-owns='LOC_GROUP_CODE_listbox']",Locationgroupcode);
		Thread.sleep(600);
		wm.Listandenter("//*[@id='LOC_GROUP_CODE_listbox']/li",Locationgroupcodeindex);
		Thread.sleep(600);
	...
	//    wm.capturetextfrommsgbox("//span[@id='diaWarningMessage']", " Bussiness partner Record created successfully ");
		...
		wm.Verifythealertpopupmessagesusincontainsusinggetattribute("//div[@id='dialogWarning']", 
				"Business partner",
				"Bussiness partner Created successfully", 
				"Bussinees  partner not created successfully");
...
//	    wm.capturetextfrommsgbox("//div[@id='dialogWarning']", " Bussiness partner Record created successfully ");
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("BusinessPartner", "BusinessPartner");
