...
public class CarCashCard
{
	...
	public void CarCashCard(String Username, String Password, String Leftsidemenu, String ActiveFrom1,
			...
			,String Carcopytickect,String Modeindex,String Cardtypedetails,String fcardnum,
			String fcardDate1,String fcardDate3,String Fopdivide,String Salesbracnh1) throws Exception
...
//Selected the Cash options
		...
		//wm.sendtextbyxvalue("//input[@aria-owns='AAtscPaybackParnerDesc_listbox']", Agentincetive);
		wm.sendtextbyxvalue("//input[@aria-owns='fbbranch_listbox']", Salesbracnh1);
		Thread.sleep(300);
...
//	Thread.sleep(50);
   ...
   Thread.sleep(8000);
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("CarCashCard", "CarCashCard");
