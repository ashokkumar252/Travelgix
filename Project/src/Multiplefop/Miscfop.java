...
public class Miscfop
{
	...
	public void Miscfop(String Username, String Password, String Leftsidemenu, String ActiveFrom1,
			...
			String FareCalculationAreaAP,String IntlSalesIndicatorAP,String Fopdivide,
			String Cardtypedetails,String fcardnum,String fcardDate1,
			String fcardDate3,String Modeindex1,String Modeindex,String Selectedbranch
) throws Exception
...
wm.Verifythedropdownvalues("//input[@name='DktNumber']",
		"Pass : MISC FOP   created successfuly" + "",
		"Fail:  MISC FOP   not created successfuly " + "");
...
*/
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("Miscfop", "Miscfop");
