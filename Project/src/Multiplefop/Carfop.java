...
public class Carfop 
{
	...
	public void logincheckK(String Username, String Password, String Leftsidemenu, String ActiveFrom1,
			...
			String Modeindex,String Modeindex1,String fbranchlistbox,String fglChargelistbox,String Fopdivide
	) throws Exception
...
//		wm.clickbyxpath("//*[@id='div_Car_Header_Details']/div[4]/div/div[1]/div[1]/a/i");
		...
		wm.clickbyxpath("//span[@aria-owns='MiscFOPModeKey_listbox']");		
		Thread.sleep(500);
		wm.Listandenter("//*[@id='MiscFOPModeKey_listbox']/li", Modeindex1);
		Thread.sleep(1200);
...
//	Thread.sleep(50);
	...
	wm.sleep();	
	 ...
	 wm.sleep();
		...
		wm.Verifythedropdownvalues("//input[@name='DktNumber']",
				"Pass : Sales Refund CAR  FOP created successfuly" + "",
				"Fail:  Sales Refund CAR   FOP not created successfuly " + "");
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("Carfop", "Carfop");
