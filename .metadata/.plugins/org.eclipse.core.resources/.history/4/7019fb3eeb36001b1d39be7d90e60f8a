...
public class Airdomesticnegative 
{
	...
	public void Airdomesticnegative(String Username, String Password, String Leftsidemenu, String Commonindex,
			...
			AatdDate3,String Domestic) throws Exception
...
//select the domestic 
wm.sendtextbyxvalue("//input[@aria-owns='AatdInterDomestic_listbox']",Domestic);
Thread.sleep(600);
wm.Listandenter("//*[@id='AatdInterDomestic_listbox']/li",Commonindex);
Thread.sleep(600);
...
//	Thread.sleep(300);
		...
		//Netpayable checking
		/*
		wm.clickbyxpath("//input[@name='AtfdDealFare']");
		wm.clickbyxpath("//input[@name='AtfdDealFare']");
		wm.clickbyxpath("//input[@name='AtfdDealFare']");
	*/
		
		Thread.sleep(300);
	wm.comparetwovaluesadd2sub1("//input[@name='AtfdDealFare']"
			, "//input[@name='TotalTaxAmount']", 
			"//input[@name='salestotcommm']", 
			"//input[@name='Amt_NetPayable']", "Net payable matches successfully", 
			"Net payable not matches successfully");
		//selling fare +total tax - commission maoun= total payable 
...
//============================================================================================================
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("Airdomesticnegative", "Airdomesticnegative");
