package Misccreditcashcarduccf;
...
public class MiscCreditCash {
	...
	public void MiscCreditCash(String Username, String Password, String Leftsidemenu, String ActiveFrom1,
			...
			String FareCalculationAreaAP,String IntlSalesIndicatorAP,String Fopdivide) throws Exception
...
wm.Verifythedropdownvalues("//input[@name='DktNumber']",
		"Pass : Sales Refund MISC cash   created successfuly" + "",
		"Fail:  Sales Refund MISC Cash   not created successfuly " + "");
...
*/
	...
	public Object[][] dp() throws IOException {
		...
		return Wrappermethods.getSheet("MiscCreditCash", "MiscCreditCash");
